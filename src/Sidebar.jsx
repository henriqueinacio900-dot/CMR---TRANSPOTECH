import { LayoutDashboard, Filter, Users, CalendarClock, RefreshCw, UserCheck, BarChart3 } from 'lucide-react'
...
const ITENS = [
  ...
  { key: 'passagem_bastao', label: 'Passagem de bastão', icone: UserCheck },
