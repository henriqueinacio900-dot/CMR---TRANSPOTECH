...
export default function ProspeccaoCard({ negocio, onAtualizado }) {
  ...
  return (
    <div style={{ background: '#fff', border: '1px solid #eee', borderRadius: 12, padding: '10px 12px' }}>
      <p style={{ fontSize: 13, fontWeight: 600, margin: 0 }}>{negocio.cliente?.razao_social}</p>
      <p style={{ fontSize: 11, color: '#777', margin: '4px 0 0' }}>
        {negocio.consultor?.nome}{ultimoContato ? ` · último contato: ${ultimoContato}` : ' · sem contato ainda'}
      </p>
